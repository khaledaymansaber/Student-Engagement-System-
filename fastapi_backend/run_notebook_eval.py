...
CSV_LABELS_PATH = Path(r'C:\Users\Compumarts\OneDrive\Desktop\projects\engagement_project\data\extracted_data\test_labels_binary.csv')

LANDMARK_PATH = Path(r'C:\Users\Compumarts\OneDrive\Desktop\projects\engagement_project\models\landmarks\shape_predictor_68_face_landmarks.dat')
YOLO_PATH     = Path(r'C:\Users\Compumarts\OneDrive\Desktop\projects\engagement_project\models\yolo\yolov8n-face-lindevs.pt')
HOPENET_PATH  = Path(r'C:\Users\Compumarts\OneDrive\Desktop\projects\engagement_project\models\hopenet\hopenet_robust_alpha1.pkl')
HSE_PATH      = Path(r'C:\Users\Compumarts\OneDrive\Desktop\projects\engagement_project\models\emotion\enet_b2_8.onnx')

OUTPUT_CSV = Path(r'C:\Users\Compumarts\OneDrive\Desktop\student_egagment_system\fastapi_backend\pipeline_blended_results.csv')
...
plt.tight_layout()
plt.savefig('confusion_matrix_notebook.png')
print('Plot saved to confusion_matrix_notebook.png')
